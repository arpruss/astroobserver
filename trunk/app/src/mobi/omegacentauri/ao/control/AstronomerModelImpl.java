...
import static mobi.omegacentauri.ao.util.Geometry.addVectors;
import static mobi.omegacentauri.ao.util.Geometry.calculateRADecOfZenith;
import static mobi.omegacentauri.ao.util.Geometry.matrixMultiply;
import static mobi.omegacentauri.ao.util.Geometry.matrixVectorMultiply;
import static mobi.omegacentauri.ao.util.Geometry.scalarProduct;
import static mobi.omegacentauri.ao.util.Geometry.scaleVector;
import static mobi.omegacentauri.ao.util.Geometry.vectorProduct;
